...
[<assembly: AssemblyTitleAttribute("lib-dotnet.Tests")>]
[<assembly: AssemblyProductAttribute("lib-dotnet")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "lib-dotnet.Tests"
    let [<Literal>] AssemblyProduct = "lib-dotnet"
